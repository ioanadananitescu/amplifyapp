...
export default function ListforArtists(props) {
  ...
  const variants = [
    {
      overrides: {
        ...
        "Rectangle 47342": { backgroundColor: "rgba(186,173,138,1)" },
        "some text7343": {},
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "ListforArtists")}
    >
      <View
        padding="0px 0px 0px 0px"
        width="508px"
      ...
      >
        <View
          ...
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Rectangle 47339")}
        ></View>
        <Text
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7340")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        <View
          ...
          border="1px SOLID rgba(0,0,0,1)"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Rectangle 47342")}
        ></View>
        <Text
          fontFamily="Montserrat"
          fontSize="36px"
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7343")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7346")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        <View
          ...
          top="0px"
          left="0px"
          {...getOverrideProps(overrides, "placeholder7348")}
        >
          <View
            width="508px"
            height="85px"
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="list&#xA;"
            {...getOverrideProps(overrides, "placeholder7350")}
          ></Text>
        </View>
        <View
          width="142px"
