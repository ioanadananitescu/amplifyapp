...
export default function Listcategories(props) {
  ...
  const variants = [
    {
      overrides: {
        ...
        "Rectangle 47277": { backgroundColor: "rgba(186,173,138,1)" },
        "some text7278": {},
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "Listcategories")}
    >
      <View
        padding="0px 0px 0px 0px"
        width="508px"
      ...
      >
        <View
          ...
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Rectangle 47274")}
        ></View>
        <Text
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7275")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        <View
          ...
          border="1px SOLID rgba(0,0,0,1)"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Rectangle 47277")}
        ></View>
        <Text
          fontFamily="Montserrat"
          fontSize="36px"
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7278")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7281")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        <View
          ...
          top="0px"
          left="0px"
          {...getOverrideProps(overrides, "placeholder7283")}
        >
          <View
            width="508px"
            height="85px"
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="list&#xA;"
            {...getOverrideProps(overrides, "placeholder7285")}
          ></Text>
        </View>
        <View
          width="142px"
