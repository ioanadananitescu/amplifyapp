...
export default function ListforBuyers(props) {
  ...
  const variants = [
    {
      overrides: {
        ...
        "Rectangle 47407": { backgroundColor: "rgba(186,173,138,1)" },
        "some text7408": {},
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "ListforBuyers")}
    >
      <View
        padding="0px 0px 0px 0px"
        width="508px"
      ...
      >
        <View
          ...
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Rectangle 47404")}
        ></View>
        <Text
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7405")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        <View
          ...
          border="1px SOLID rgba(0,0,0,1)"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Rectangle 47407")}
        ></View>
        <Text
          fontFamily="Montserrat"
          fontSize="36px"
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7408")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="some text&#xA;"
          {...getOverrideProps(overrides, "some text7411")}
        ></Text>
      </View>
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        <View
          ...
          top="0px"
          left="0px"
          {...getOverrideProps(overrides, "placeholder7413")}
        >
          <View
            width="508px"
            height="85px"
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="list&#xA;"
            {...getOverrideProps(overrides, "placeholder7415")}
          ></Text>
        </View>
        <View
          width="142px"
